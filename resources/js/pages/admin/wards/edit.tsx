        ...
        <>
            ...
            <div className="border-border bg-card shadow-layer-1 max-w-2xl overflow-hidden rounded-xl border">
                <div className="border-b border-border border-t-4 border-t-primary bg-muted/50 px-6 py-5">
                    <h2 className="headline-sm font-bold text-foreground">Edit Ward Details</h2>
                    <p className="body-sm mt-0.5 text-muted-foreground">Update ward capacity, physical location, and matron oversight.</p>
                </div>
