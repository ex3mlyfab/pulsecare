...
- Composed of matching translucent background, darkened text, and boundary stroke:
    - _Stable/Discharged_: BG `#ECFDF5`, Text `#065F46`, Stroke `#A7F3D0`.
    - _Transfer/Delay_: BG `#FFFBEB`, Text `#92400E`, Stroke `#FDE68A`.
    - _Critical/ICU_: BG `#EEF2FF`, Text `#3730A3`, Stroke `#C7D2FE`.
    - _Urgent Alert_: BG `#FEF2F2`, Text `#991B1B`, Stroke `#FECACA`.
